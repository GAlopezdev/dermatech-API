...
public class UsuarioController {
    ...
    @PostMapping("/login")
    public ResponseEntity<UsuarioDTO> login(@RequestBody LoginDTO loginData) {
        UsuarioDTO usuario = usuarioService.login(loginData.getEmail(), loginData.getContrasenia());
        if (usuario != null) {
            return ResponseEntity.ok(usuario);
        } else {
